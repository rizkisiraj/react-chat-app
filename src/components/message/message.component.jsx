...
const Message = ({data}) => {
    ...
    return (
        <div className={`flex items-start gap-3 ${uid === currentUser.uid ? "flex-row-reverse" : null}`}>
                {
                    uid!==currentUser.uid ? <img className="w-12 h-12 rounded-full" src={profileURL || "https://i.picsum.photos/id/1004/200/200.jpg?hmac=BBw0FlC3mc-tTzAKHYRFQtbGl6PZKtN51p8L0101ekQ"} alt="foto-profil" /> : null 
                }
